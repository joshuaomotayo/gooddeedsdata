/*
  # Initial Database Schema for GoodDeeds Data VPN App
...
INSERT INTO data_plans (id, name, type, data_amount, price, validity_days, description, features, is_popular) VALUES
  ('free-plan', 'Free Starter', 'free', 3072, 0.00, 30, 'Perfect for getting started - 3GB free for 30 days', '["3GB data for 30 days", "Basic speed", "Standard support", "One-time offer"]', false),
  ('payg-plan', 'Pay As You Go', 'payg', 0, 0.20, 30, 'Flexible usage with per-MB billing from wallet balance', '["₦0.20 per MB", "No daily limits", "High-speed connection", "Priority support"]', true),
  ('bundle-1gb', '1GB Bundle', 'bundle', 1024, 150.00, 7, 'Great value for regular users', '["1GB data", "7 days validity", "High-speed connection", "Priority support"]', false),
  ('bundle-5gb', '5GB Bundle', 'bundle', 5120, 650.00, 30, 'Perfect for heavy users and streaming', '["5GB data", "30 days validity", "Ultra-high speed", "Premium support"]', false),
  ('bundle-10gb', '10GB Bundle', 'bundle', 10240, 1200.00, 30, 'Ultimate data package for power users', '["10GB data", "30 days validity", "Ultra-high speed", "Premium support", "Priority network"]', false);
